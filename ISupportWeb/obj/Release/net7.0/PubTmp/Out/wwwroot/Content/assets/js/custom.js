    ...
    for (var i = 0; i < data.length; i++) {
        ...
        if (data[i].Type == "Item") {
            ...
            if (data[i].Image == "" || data[i].Image == null) {
                ...
                html += '<td class="plantmore-product-thumbnail"><a href="/Product/ServiceDetails?ServiceID=' + data[i].ServiceID + '"><img class="wishlist-img" src="http://admin.isupportbh.com/' + data[i].Image + '" alt=""></a></td>'
            }
        }
        if (data[i].Type == "Item") {
            if (data[i].DiscountedPrice == 0 || (data[i].DiscountedPrice == null)) {
